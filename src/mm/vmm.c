...
void vmm_init() {
    ...
    /* im declaring start addresses here even if i set the text uptr to this just for consistency*/
    ...
    vmm_switch_pm(vmm_kernel_pm); /* after running this, when i call dprintf i get a triple fault!*/
